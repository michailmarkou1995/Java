...
public class PlayerController extends Mob {
	...
	public static double  y, rotation, xa, za, rotationa, rotationUpa, rotationUp=1
			, distanceTravel=0.0, distanceTravelX=0.0, distanceTravelY=0.0;//rest On Entity which this class extends Mob to Entity link
