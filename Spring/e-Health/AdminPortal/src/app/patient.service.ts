...
export class UserService {
  ...
  public addPatient(patient: Patient) {//save
    ...
    var hardcoded = [{"username":"michailkalinx","password":"$2a$12$rsbXuaMWQMSUjMQlqTAay.vgmHOStVkj/3Gd8WktHHwNy4ogfFtcG","firstName":"Michail","lastName":"Markou","email":"backtrackpower@gmail.com","phone":"6908990119","city":null,"streetAddress":null,"dateOfBirth":"2021-06-03","enabled":true,"doctorIs":false,"patientID":2,"doctor":null,"accountNonLocked":true,"authorities":[{"authority":"ROLE_ADMIN"}],"credentialsNonExpired":true,"accountNonExpired":true}];
    var hardcoded1 = {"username":"heroku","password":"$2a$12$rsbXuaMWQMSUjMQlqTAay.vgmHOStVkj/3Gd8WktHHwNy4ogfFtcG","firstName":"heroku","lastName":"heroku","email":"backtrackpower@heroku.com","phone":"6908990119","dateOfBirth":"2021-06-03"};
  ...
  public addDoctor(patient: any) {//save
    console.log("sends json Patient insert");
    var hardcoded = [{"username":"michailkalinx","password":"$2a$12$rsbXuaMWQMSUjMQlqTAay.vgmHOStVkj/3Gd8WktHHwNy4ogfFtcG","firstName":"Michail","lastName":"Markou","email":"backtrackpower@gmail.com","phone":"6908990119","city":null,"streetAddress":null,"dateOfBirth":"2021-06-03","enabled":true,"doctorIs":false,"patientID":2,"doctor":null,"accountNonLocked":true,"authorities":[{"authority":"ROLE_ADMIN"}],"credentialsNonExpired":true,"accountNonExpired":true}];
    var hardcoded1 = {"username":"senpai","password":"$2a$12$rsbXuaMWQMSUjMQlqTAay.vgmHOStVkj/3Gd8WktHHwNy4ogfFtcG","firstName":"senpai","lastName":"senpai","email":"backtrackpower@senpai.com","phone":"6908990119","dateOfBirth":"2021-06-03", "category":
    "guru"};
